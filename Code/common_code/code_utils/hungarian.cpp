...
//********************************************************//
float HungarianAlgorithm::solve(const cv::Mat1f &distMatrix, vector<int> &assignment) {
  ...
  Mat1f distMatrixTransposed = distMatrix.t();

  // call solving function
  assignmentOptimal(&assignment[0], &cost, distMatrixTransposed.ptr<float>(0, 0), nRows, nCols);
